...
Ext.define('MyApp.view.RubrosPanel', {
  extend: 'Ext.panel.Panel',
  alias: 'widget.rubrospanel',

  requires: [
    'MyApp.view.LotesPanelViewModel1',
    'Ext.panel.Tool',
    'Ext.grid.Panel',
    'Ext.view.Table',
  ...
  onPanelRender: function(component, eOpts) {
    this.store_name = 'Rubros';
    this.model_name = 'MyApp.model.Rubros';
